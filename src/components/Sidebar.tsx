...
export default function Sidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar container */}
      <aside
        className={`fixed top-0 bottom-0 left-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-r border-slate-150 dark:border-slate-800/80 flex flex-col justify-between transform transition-all duration-300 lg:sticky lg:top-28 ${
          isOpen
            ? "translate-x-0 w-64 opacity-100 visible p-5 lg:translate-x-0 lg:opacity-100 lg:visible lg:w-64 lg:h-[calc(100vh-9.5rem)] lg:border lg:border-slate-200/50 lg:dark:border-slate-800/80 lg:rounded-3xl lg:shadow-sm lg:p-6"
      ...
      >
        <div className="space-y-6 overflow-y-auto max-h-[75vh] pr-1 scrollbar-thin dark:scrollbar-thumb-slate-800 scrollbar-thumb-slate-200 scrollbar-track-transparent">
          {/* Mobile Header Title */}
          <div className="flex items-center justify-between lg:hidden border-b border-slate-100 dark:border-slate-800 pb-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-bold text-slate-800 dark:text-slate-200">{t.categoryAll}</span>
            </div>
            <button
              onClick={() => setIsOpen(false)}
          ...
          <div>
            <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 tracking-wider uppercase block mb-3 pl-3">
                  ...
                  >
                    ...
                    <span
                      className={`text-[10px] px-2 py-0.5 rounded-lg font-mono font-bold transition-colors shrink-0 ${
                        isActive
                          ? "bg-indigo-700 dark:bg-indigo-850 text-indigo-100"
        ...
        <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-800 space-y-4">
          ...
          <div className="text-center">
            ...
            <p className="text-[9px] text-slate-300 dark:text-slate-600 mt-0.5 font-mono">
